...
public class Matrix {
    ...
    private final double[][] data;   // array of data
    ...
    /**
     * Vector functions in integration with matrices
     */

    public static Matrix FromVector3(Vector3D v)
    {
    	return new Matrix(new double[][] { {v.getX()}, {v.getY()}, {v.getZ()}, {1}});
    }

    public Vector3D ToVector3ByW() {
    	return new Vector3D(value(0, 0) / value(3, 0), value(1, 0) / value(3, 0), value(2, 0) / value(3, 0));
    }

    public Vector3D ToVector3Col() {
    	return new Vector3D(value(0, 0), value(1, 0), value(2, 0));
    }

    public Vector3D ToVector3Row() {
    	return new Vector3D(value(0, 0), value(0, 1), value(0, 2));
    }
}